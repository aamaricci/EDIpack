...
add_global_variable(global_env, "total_ud", c_bool.in_dll(libedi2py, "ed_total_ud"), "value")
add_global_variable(global_env, "twin", c_bool.in_dll(libedi2py, "ed_twin"), "value")
